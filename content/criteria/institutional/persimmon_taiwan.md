...
台湾向け柿は山形県で近年輸出が伸びている品目（県統計でR5の6tからR6は27tへ増加）。
生果実のため生産園地登録・植物検疫証明書等の検疫条件への対応が主な論点。
...
- id: orchard-registration
  ...
  step_ref: persimmon_taiwan#orchard-registration
- id: phytosanitary-cert
  points: -5
  label: 植物検疫証明書が必要
  remedy: 輸出前に植物防疫所の検査を受け、植物検疫証明書の交付を受ける
  step_ref: persimmon_taiwan#phytosanitary-cert
