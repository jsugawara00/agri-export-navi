...
米国向けりんごは輸出可能だが、病害虫対策としての園地・施設登録と体系的防除、
輸出前検査、FDAの食品安全規制など要件が多く、計画的な準備が必要。
